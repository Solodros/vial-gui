...
from keycodes.keycodes import KEYCODES_SPECIAL, KEYCODES_BASIC, KEYCODES_SHIFTED, KEYCODES_ISO, KEYCODES_BACKLIGHT, \
    KEYCODES_MEDIA, KEYCODES_USER, Keycode, KEYCODES_DIAL_BASE, KEYCODES_RGBLIGHT, KEYCODES_RGBLIGHT_MODE, KEYCODES_RGB_MATRIX_CONTROL_ADV, \
    KEYCODES_RGB_MATRIX_CONTROL_ADV_LOGO, KEYCODES_RGB_MATRIX_CONTROL_BASE, KEYCODES_UG_RGB_MATRIX_BASE, \
    KEYCODES_UG_RGB_MATRIX_ADV, KEYCODES_RGB_MATRIX_IND, KEYCODES_RGB_MATRIX_IND_ADV
...
class AnyKeycode:
    ...
    def prepare_names(self):
        for kc in KEYCODES_SPECIAL + KEYCODES_BASIC + KEYCODES_SHIFTED + KEYCODES_ISO + KEYCODES_BACKLIGHT + \
                  KEYCODES_MEDIA + KEYCODES_USER + KEYCODES_DIAL_BASE + KEYCODES_RGBLIGHT + KEYCODES_RGBLIGHT_MODE+ KEYCODES_RGB_MATRIX_CONTROL_ADV+ \
                  KEYCODES_RGB_MATRIX_CONTROL_ADV_LOGO+ KEYCODES_RGB_MATRIX_CONTROL_BASE+ KEYCODES_UG_RGB_MATRIX_BASE+ \
                  KEYCODES_UG_RGB_MATRIX_ADV+KEYCODES_RGB_MATRIX_IND+KEYCODES_RGB_MATRIX_IND_ADV:
